    ...
    <div style={{ fontFamily: 'DM Sans, sans-serif', background: 'linear-gradient(160deg,#0A2342 0%,#081A30 40%,#0A2342 100%)', minHeight: '100vh', color: 'white' }}>
      ...
      <section className="about-founding-grid" style={{ padding: '72px 24px', maxWidth: 860, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
        <div>
          ...
          <p style={{ color: 'rgba(255,255,255,0.55)', lineHeight: 1.8, marginBottom: 16 }}>
            After 30+ years scaling products at Pearson and watching organizations struggle to get real work done â not just staffed â our founder Jodi Mac built Work Simplr to solve the root problem.
          </p>
      ...
      <section style={{ background: '#0A2342', padding: '72px 24px', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ marginTop: 24, color: 'rgba(255,255,255,0.45)', fontSize: '0.95rem', lineHeight: 1.7 }}>
            We're building the operating system for distributed knowledge work â where AI handles scoping, college talent handles execution, and employers get deliverables, not status updates.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '72px 24px', maxWidth: 960, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <h2 style={{ fontFamily: SERIF, fontSize: 'clamp(1.6rem,3vw,2.2rem)', fontWeight: 400 }}>SprintWorkâ¢ vs. everything else</h2>
        </div>
      ...
      <section style={{ padding: '72px 24px', maxWidth: 860, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <h2 style={{ fontFamily: SERIF, fontSize: 'clamp(1.6rem,3vw,2.2rem)', fontWeight: 400 }}>The people behind SprintWorkâ¢</h2>
        </div>
          ...
          {[
            {
              ...
              name: 'Jodi Mac',
              title: 'Founder & CEO',
              bio: '30+ years in EdTech, including scaling products at Pearson. Jodi built Work Simplr after watching organizations consistently fail at the same place â not execution, but definition. She bootstrapped the company for 3.5 years before raising from Techstars and Gener8tor.',
            ...
            },
            {
              ...
              bio: '30+ years in EdTech building and managing $1B in sales and revenue operations. Eric brings deep expertise in sales ops, data ops, and scaling go-to-market teams â the operational backbone behind how Work Simplr delivers at scale.',
              isQuote: false,
            },
          ].map(person => (
      ...
      <section style={{ padding: '72px 24px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
          <Link href="/register?role=employer" style={{ padding: '14px 36px', background: '#E07B39', borderRadius: 999, color: 'white', textDecoration: 'none', fontWeight: 600, fontSize: '0.95rem', boxShadow: '0 8px 24px rgba(224,123,57,0.4)' }}>Start a Sprint â</Link>
          <Link href="/students" style={{ padding: '14px 28px', border: '1px solid rgba(255,255,255,0.15)', borderRadius: 999, color: 'rgba(255,255,255,0.7)', textDecoration: 'none', fontSize: '0.95rem' }}>Join as a Sprint-Ternâ¢</Link>
        </div>
      </section>
